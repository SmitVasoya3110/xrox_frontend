...
square_application_id = NODE_ENV.toString().toLocaleLowerCase() === "development" ? process.env.REACT_APP_APPLICATION_ID_DEV : process.env.REACT_APP_APPLICATION_ID_LIVE
square_location_id = NODE_ENV.toString().toLocaleLowerCase() === "development" ? process.env.REACT_APP_LOCATION_ID_DEV : process.env.REACT_APP_LOCATION_ID_LIVE
